...
public class PocAggregateDefinition extends AbstractComponentDefinition {

    public static final String NAME = "PocAggregate";

    public PocAggregateDefinition() {
        super(NAME, ExecutionEngine.BEAM);
    }

    @Override
    public Class<PocAggregateProperties> getPropertyClass() {
        return PocAggregateProperties.class;
    }
