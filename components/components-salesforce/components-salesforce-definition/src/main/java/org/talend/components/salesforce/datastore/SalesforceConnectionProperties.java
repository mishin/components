...
public class SalesforceConnectionProperties extends ComponentPropertiesImpl
    ...
    //
    public static final String OAUTH = "oauth";// TODO remove this, widget can be found with field instances

    public OauthProperties oauth = new OauthProperties(OAUTH);

    public Property<String> apiVersion = newString("apiVersion");

    public static final String USERPASSWORD = "userPassword";// TODO remove this, widget can be found with field
                                                             // instances
    ...
    public void setupLayout() {
        ...
        advancedForm.addRow(widget(endpoint).setHidden());
